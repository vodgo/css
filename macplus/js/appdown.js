...
var appdw1 = '<div class="layui-waper"><div class="layer-iframe"><div class="layer-content layer_notice"><a href="../APP/" class="close">下载APP</a><a href="javascript:;" class="link">跳过</a></div></div></div>';
(function() {
    if (!isWeiXin()) {
